...
- June 30, 2025: Replaced Help Request Center icons with custom graphics - clerk icon for "Active Help Requests", insurance hand icon for "Help Request Center", book icon for "Daily Cover Count Reports", safety exit icon for "Request Help" section, and send email icon for "Submit Cover Count Report" functionality
