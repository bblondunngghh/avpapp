    ...
    <div className="flex flex-col items-center justify-center min-h-screen bg-gray-50 p-4">
      <div className="max-w-2xl w-full bg-white rounded-lg shadow-lg p-8">
        ...
        <div className="bg-blue-50 rounded-md border border-blue-200 p-4 mb-6">
          <h3 className="font-bold text-blue-800 mb-2">Report Details</h3>
          <p className="text-gray-600">
            The shift report has been successfully processed and stored. Your report includes:
          </p>
          <ul className="mt-2 space-y-1 text-gray-700 list-disc list-inside">
            <li>Number of cars parked</li>
            <li>Total turn-in amount</li>
            <li>Employee payroll details with hours distribution</li>
            <li>Financial calculations for the shift</li>
          </ul>
        </div>
