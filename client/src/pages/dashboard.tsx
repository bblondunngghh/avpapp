...
import arrowButtonRightIcon from "@assets/Arrow-Button-Right-3--Streamline-Ultimate.png";
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
        ...
        <Card className="hover:shadow-xl transition-all duration-300 overflow-hidden group border-t-4 border-t-blue-500 bg-gradient-to-b from-white to-blue-50/30">
          <CardContent className="pt-6 pb-8 px-5 flex flex-col items-center text-center h-full">
            ...
            >
              Create Report <img src={arrowButtonRightIcon} alt="Arrow Button Right" className="ml-2 h-4 w-4 group-hover:translate-x-1 transition-transform" />
            </Button>
          </CardContent>
        </Card>
        ...
        <Card className="hover:shadow-xl transition-all duration-300 overflow-hidden group border-t-4 border-t-amber-500 bg-gradient-to-b from-white to-amber-50/30">
          <CardContent className="pt-6 pb-8 px-5 flex flex-col items-center text-center h-full">
            ...
            >
              Report Incident <img src={arrowButtonRightIcon} alt="Arrow Button Right" className="ml-2 h-4 w-4 group-hover:translate-x-1 transition-transform" />
            </Button>
          </CardContent>
        </Card>
        ...
        <Card className="hover:shadow-xl transition-all duration-300 overflow-hidden group border-t-4 border-t-teal-500 bg-gradient-to-b from-white to-teal-50/30">
          <CardContent className="pt-6 pb-8 px-5 flex flex-col items-center text-center h-full">
            ...
            >
              View Guidelines <img src={arrowButtonRightIcon} alt="Arrow Button Right" className="ml-2 h-4 w-4 group-hover:translate-x-1 transition-transform" />
            </Button>
          </CardContent>
        </Card>
        ...
        <Card className="hover:shadow-xl transition-all duration-300 overflow-hidden group border-t-4 border-t-purple-500 bg-gradient-to-b from-white to-purple-50/30">
          <CardContent className="pt-6 pb-8 px-5 flex flex-col items-center text-center h-full">
            ...
            >
              View Permits <img src={arrowButtonRightIcon} alt="Arrow Button Right" className="ml-2 h-4 w-4 group-hover:translate-x-1 transition-transform" />
            </Button>
          </CardContent>
        </Card>
      </div>
