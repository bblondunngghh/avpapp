...
export default function Dashboard() {
  ...
  return (
    <div className="max-w-4xl mx-auto px-4 mt-4 md:mt-0 relative">
        ...
        <div className="relative text-center mb-12 p-8 rounded-3xl overflow-hidden shadow-2xl border border-white/20 backdrop-blur-xl" style={{background: "url('/background.jpg') center center / cover no-repeat"}}>
        ...
        <div className="relative overflow-hidden rounded-2xl p-8 mt-12 border border-white/20 backdrop-blur-xl shadow-2xl" style={{background: "url('/background.jpg') center center / cover no-repeat"}}>
          {/* Enhanced Glass morphism overlay */}
