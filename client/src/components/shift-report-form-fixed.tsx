...
import EmployeeHoursDistribution from "./employee-hours-distribution";
          ...
          <div className="form-card">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-x-6 gap-y-4">
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    <FormLabel className="text-gray-700 font-medium text-sm">Receipt Transactions</FormLabel>
                    <FormControl>
                      <Input type="number" min="0" className="paperform-input" {...field} />
                    </FormControl>
                    <div className="text-xs text-gray-600 mt-1">
                      <div>Receipt Sales: ${(Number(field.value) * 18).toFixed(2)}</div>
                    </div>
                    <FormMessage />
                  </FormItem>
                )}
                ...
                render={({ field }) => (
                  <FormItem>
                    <FormLabel className="text-gray-700 font-medium text-sm">
                      {expectedCompanyCashTurnIn >= 0 ? "Company Cash Turn-In ($)" : "Money Owed ($)"}
                    </FormLabel>
                    <FormControl>
                      <InputMoney 
                        className="paperform-input" 
                        value={expectedCompanyCashTurnIn >= 0 ? field.value : Math.abs(expectedCompanyCashTurnIn)}
                    ...
                    {!isMatched && (
                      <div className="text-xs text-red-500 mt-1">
                        {expectedCompanyCashTurnIn >= 0 ? 
                          `Expected Company Cash Turn-In: $${expectedCompanyCashTurnIn.toFixed(2)}` : 
                          `Expected Money Owed: $${Math.abs(expectedCompanyCashTurnIn).toFixed(2)}`
                        }
                      </div>
                    )}
                    <FormMessage />
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-x-6 gap-y-4">
                ...
                <div className="financial-summary-item">
                  ...
                  <div className="text-xs text-gray-600">
                    {creditTransactions} transactions × $4.00
                  </div>
                </div>
                ...
                <div className="financial-summary-item">
                  ...
                  <div className="text-xs text-gray-600">
                    |{creditTransactions} × $15 - ${totalCreditSales.toFixed(2)}|
                  </div>
                </div>
                ...
                <div className="financial-summary-item">
                  ...
                  <div className="text-xs text-gray-600">
                    |{cashCars} × $15 - ${totalCashCollected.toFixed(2)}|
                  </div>
                </div>
                ...
                <div className="financial-summary-item">
                  ...
                  <div className="text-xs text-gray-600">
                    {totalReceipts} receipts × $3.00
                  </div>
                </div>
                
                {/* Total Commission */}
                <div className="financial-summary-item font-medium">
                  <div className="flex justify-between">
                ...
                <div className="financial-summary-item font-bold">
                  <div className="flex justify-between">
            ...
            <div className="mt-8">
              <h3 className="section-title uppercase font-bold">ADDITIONAL INFORMATION</h3>
              ...
              <div className="grid grid-cols-1 gap-y-4">
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      ...
                      <FormControl>
                        <Textarea 
                          className="paperform-input min-h-[100px]" 
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      <FormLabel className="text-gray-700 font-medium text-sm">Incidents or Complaints</FormLabel>
                      <FormControl>
                        <Textarea 
                          className="paperform-input min-h-[100px]" 
                          placeholder="List any incidents or complaints..." 
                          {...field} 
                        />
                      </FormControl>
                      <FormMessage />
